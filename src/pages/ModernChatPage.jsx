...
const ModernChatPage = () => {
  ...
  useEffect(() => {
    ...
    // Add class to body for theme transition
  ...
  return (
    <div className={`pt-16 pb-8 min-h-[90vh] flex items-center justify-center theme-transition ${isDarkMode ? 'bg-gradient-to-b from-gray-900 to-black' : 'bg-gradient-to-b from-blue-50 to-indigo-50'}`}>
        ...
        <Card className={`overflow-hidden border-none ${isDarkMode ? 'glassmorphism-dark' : 'glassmorphism'} shadow-[0_0_45px_-15px_rgba(79,70,229,0.25)] animate-fadeIn transition-all duration-500`}>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex space-x-2">
                ...
                <button 
                  ...
                  className={`p-2 rounded-full transition-all duration-300 ${isDarkMode ? 'bg-gray-800 text-blue-300 hover:bg-gray-700' : 'bg-blue-100 text-blue-800 hover:bg-blue-200'} hover-scale`}
                ...
                <button 
                  onClick={toggleTheme}
                  className={`p-2 rounded-full transition-all duration-500 hover-scale ${isDarkMode ? 'bg-gray-800 hover:bg-gray-700' : 'bg-blue-100 hover:bg-blue-200'}`}
                ...
                >
                  <div className="relative w-5 h-5 overflow-hidden">
                    ...
                    <svg 
                      ...
                      className={`absolute inset-0 h-5 w-5 transition-all duration-500 ${isDarkMode ? 'opacity-0 rotate-90 scale-0' : 'opacity-100 rotate-0 scale-100'}`} 
                      fill="none" 
                      viewBox="0 0 24 24" 
                      stroke="#F59E0B"
                    >
                    ...
                    <svg 
                      xmlns="http://www.w3.org/2000/svg" 
                      className={`absolute inset-0 h-5 w-5 transition-all duration-500 ${isDarkMode ? 'opacity-100 rotate-0 scale-100' : 'opacity-0 -rotate-90 scale-0'}`} 
                      fill="none" 
                      viewBox="0 0 24 24" 
                      stroke="#A5B4FC"
                    >
            ...
            <div className={`h-[65vh] overflow-y-auto ${isDarkMode ? 'bg-gradient-to-b from-gray-900/70 to-black/70' : 'bg-gradient-to-b from-gray-50 to-white'} p-6 space-y-6`}>
              {messages.map((message) => (
                ...
                >
                  ...
                  <div 
                    ...
                    style={{
                      borderRadius: '18px',
                      borderBottomRightRadius: message.sender === 'user' ? '0' : '18px',
                      borderBottomLeftRadius: message.sender === 'bot' ? '0' : '18px'
                    }}
                  >
                      ...
                      {message.sender === 'bot' && (
                        <div className="flex space-x-2">
                          <button 
                            ...
                            className="text-xs opacity-70 hover:opacity-100 transition-opacity hover-scale"
              ...
              {isTyping && (
                <div className="flex justify-start animate-fadeIn">
                  ...
                  <div 
                    className={`${isDarkMode ? 'bg-gray-800/80 text-gray-100 border border-white/5' : 'bg-white text-gray-800 border border-gray-200 shadow-md'} p-4 chat-bubble-bot`}
                    style={{
                      borderRadius: '18px',
          ...
          {feedbackVisible && (
            <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 animate-fadeIn">
              <div className={`${isDarkMode ? 'bg-gray-900 text-white' : 'bg-white text-gray-800'} p-6 rounded-xl shadow-lg max-w-md w-full mx-4 ${isDarkMode ? 'glassmorphism-dark' : 'glassmorphism'}`}>
                ...
                <div className="flex justify-center space-x-2 mb-6">
                  {[1, 2, 3, 4, 5].map((rating) => (
                    <button
                      ...
                      className={`text-2xl transition-transform ${currentRating >= rating ? 'text-yellow-400 scale-110 star-pop' : 'text-gray-400'} hover:scale-110`}
                    >
                      ★
                    </button>
                  ))}
                ...
                <div className="mb-4">
                  ...
                  <textarea
                    id="feedback-comment"
                    rows="3"
                    className={`w-full px-3 py-2 rounded-md ${isDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-gray-50 border-gray-300'} focus:outline-none focus:ring-2 focus:ring-blue-500`}
                ...
                <div className="flex justify-end space-x-3">
                  <Button 
                    ...
                    className={`hover-scale ${isDarkMode ? 'border-gray-700 text-gray-300' : ''}`}
                  >
                    Cancel
                  </Button>
                  <Button 
            ...
            <div className="flex space-x-3 pb-2">
              {suggestions.map((suggestion, index) => (
                <button
                  ...
                  className={`px-4 py-2 ${isDarkMode ? 'bg-gray-800/80 text-gray-300 border border-white/5' : 'bg-white text-gray-700 border border-gray-200'} text-sm rounded-full whitespace-nowrap transition-all duration-300 hover-scale hover-glow flex items-center`}
                >
          ...
          <CardFooter className={`p-4 ${isDarkMode ? 'bg-gray-900/90' : 'bg-white'} border-t ${isDarkMode ? 'border-white/10' : 'border-gray-200'}`}>
            <form onSubmit={handleSubmit} className="flex w-full space-x-2">
              ...
              <Button 
                ...
                className={`rounded-full p-0 w-10 h-10 flex items-center justify-center ${isDarkMode && !isSpeaking ? 'border-gray-700 text-gray-300' : ''} hover-scale`}
              ...
              {/* Send Button */}
              <Button type="submit" variant="gradient" className="rounded-full p-0 w-10 h-10 flex items-center justify-center hover-scale hover-glow">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">

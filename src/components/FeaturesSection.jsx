    ...
    <section className="py-16 md:py-24 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Supercharged with Intelligent Features</h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            UNIBOT combines cutting-edge AI with thoughtful design to create a powerful assistant that
